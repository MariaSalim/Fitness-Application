...
public class ChangePasscode extends AppCompatActivity {
    ...
    public boolean LoginUserChk()
    {
        ...
        String sql = "SELECT "+DatabaseContract.Users.COL_USERNAME+","+DatabaseContract.Users.COL_PASSCODE +" FROM " +  DatabaseContract.Users.TABLE_NAME + " WHERE " + DatabaseContract.Users.COL_USERNAME+ " =? "+ " AND " + DatabaseContract.Users.COL_SECURITYCODE +" =?";
